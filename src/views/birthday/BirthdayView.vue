...
<template>
  ...
  <div class="container container2" v-if="page === 'loader'">
  ...
  <div class="container container3" v-if="page === 'card'">
    <h1>
...
.infos[type="text"], input[type="age"] {
  width: 100%;
  height: 70px;
  padding: 10px;
  font-size: 32px;
...
.hat {
  ...
  width: 180px;
  height: 180px;
  transform: rotate(30deg) translate(30px, 90px);
}
